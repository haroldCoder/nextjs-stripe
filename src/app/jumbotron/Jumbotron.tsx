...
export default function Jumbotron() {
  ...
  return (
    <div className='p-16 bg-gray-600'>
        <h1 className={`title text-5xl mb-6 bg-gradient-to-b bg-clip-text transition-colors duration-300 ease-in-out text-transparent ${!gradient ? 'from-blue-600 to-slate-100' : 'to-gray-400 from-gray-700'}`}>Vip koderx.</h1>
